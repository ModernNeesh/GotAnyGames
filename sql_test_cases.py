...
update_data_with_pkey(new_df, 'test_case_1', has_updated_at=True)

#The dataframe test_case_1 in postgres should have the original names
...
update_data_with_pkey(new_df, 'test_case_2', has_updated_at=True)

#Test_case_2 should only have updated names for second and third ids


#Test case 3: Update an existing dataframe without using update data
initialize_test_case('test_case_3')
update_data_with_pkey(new_df, 'test_case_3', has_updated_at=False)

#Test_case_3 should have updated names in all rows
